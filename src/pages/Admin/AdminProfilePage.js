      ...
      <aside className='bg-white w-full md:max-w-60 customShadow'>
        ...
        <div className='p-4'>
          <nav className='grid gap-2'>
            <Link to={"AdminEditProfile"} className='px-2 py-1 rounded hover:bg-slate-100'>Edit Profile</Link>
            <Link to={"AdminProductsPage"} className='px-2 py-1 rounded hover:bg-slate-100'>Products</Link>
          </nav>
        </div>
      </aside>
